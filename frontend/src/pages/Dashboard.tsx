    ...
    <>
      <div>
        ...
        <div className="min-w-screen min-h-screen bg-white">
          ...
          <div className="w-full h-full text-black flex flex-wrap items-start justify-center p-3 gap-4">
            {contents.length === 0 ? (
              <div className="text-center flex justify-center items-center font-semibold text-xl h-[70vh] text-black">
